...
<html>
    <head>
        ...
        <title><?= (!empty($title) ? $title: "dashboard"); ?> | TotalStationManagement Application</title>
        <!-- favicon
        ============================================ -->
        ...
        <div class="wrapper">
            <header class="main-header">
                ...
                <a href="" class="logo">
                    ...
                    <span class="logo-mini">TotalStation</span>
                    <!-- logo for regular state and mobile devices -->
                    <span class="logo-lg">TotalStation</span>
                </a>
            ...
            <aside class="main-sidebar">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
						...
						<li>
                            <a href="#">
                                <i class="fa fa-cubes"></i> <span>Carburants</span>
                            </a>
                            <ul class="treeview-menu">
								<li class="active">
                                    <a href="<?php echo site_url('intrant/add');?>"><i class="fa fa-plus"></i> Creer nouveau carburant</a>
                                </li>
								<li>
                                    <a href="<?php echo site_url('intrant/index');?>"><i class="fa fa-list-ul"></i> Listing Carburants</a>
                                </li>
							</ul>
                        </li>
                        ...
                        <li>
                            <a href="#">
                                <i class="fa fa-refresh"></i> <span>Sortie Stock</span>
                            </a>
                            <ul class="treeview-menu">
                                <li class="active">
                                    <a href="<?php echo site_url('demande/add');?>"><i class="fa fa-plus"></i> Creer nouvelle sortie</a>
                                </li>
                                <li>
                                    <a href="<?php echo site_url('demande/index');?>"><i class="fa fa-list-ul"></i>Listing Sorties </a>
                                </li>
                         ...
                         <li>
                            <a href="#">
                                <i class="fa fa-shopping-cart"></i> <span>Points de vente</span>
                            </a>
                            <ul class="treeview-menu">
                                <li class="active">
                                    <a href="<?php echo site_url('shopVente/add');?>"><i class="fa fa-plus"></i> Creer nouveau point vente</a>
                                </li>
                                <li>
                                    <a href="<?php echo site_url('shopVente/index');?>"><i class="fa fa-list-ul"></i>Listing Points vente </a>
                                </li>
