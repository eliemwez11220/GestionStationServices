...
<head>
    ...
    <title><?= $title ? $title : 'Bienvenue' ?> | TotalStationManagement Applicattion !</title>
            ...
            <div class="hpanel">
                <div class="panel-body">
                    <div class="text-center m-b-md custom-login">
                        ...
                        <?php } else { ?>
                            <b>TotalStationManagement Application</b>!
                ...
                <div class="col-sm-6">
                    <div class="float-left text-left">
                        ...
                        <img src="<?= base_url(); ?>global/img/logo/coding.png"
                            ...
                            | <a href="https://congoagile.com" style="background-color: transparent; color: white; font-weight: bold;">TotalStationManagement Application</a>
                        </span>
                    </div>
                </div>
                <div class="col-sm-6" >
                    <div class="float-right text-right" style="margin-right: 10px!important;">
                        ...
                        <span class="small" style="background-color: transparent; color: #ffffff; font-weight: bold;">
                            TotalStationManagement et son logo sont des marques déposées de
